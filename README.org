...
different languages. The reasons why you might want to use this:
 ...
 - Concise input-grammar format and intuitive algorithm: generates
   recursive top-down parsers based on [[https://doi.org/10.1145/964001.964011][Parsing Expression Grammars]]
...
For instance, let's inspect the [[https://github.com/clarete/langlang/blob/205d212cdf9ebe00a7ff4b367e818af98ec32d89/grammars/json.peg][json]] grammar:

#+begin_src bash
langlang run --grammar-file grammars/json.peg --start-rule JSON
#+end_src

Notice that the ~start-rule~ points to the [[https://github.com/clarete/langlang/blob/205d212cdf9ebe00a7ff4b367e818af98ec32d89/grammars/json.peg#L3][PEG rule]] which points to its siblings and in this particular case is labeled by the nonterminal ~JSON~
...
Take a look at the [[https://github.com/clarete/langlang/tree/205d212cdf9ebe00a7ff4b367e818af98ec32d89/grammars][~grammars~]] directory of the Langlang repo which contains definitions for common grammars such as JSON, CSV, RFC3986 URI's et cetera.
