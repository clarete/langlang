...
//go:generate go run ../../cmd/langlang -grammar ./tiny.peg -output-language go -output-path ./tiny.go -disable-inline-defs=false
...
func assertExpr(t *testing.T, input, expected string) {
	...
	require.Equal(t, expected, v.Pretty(v.Root()))
}
