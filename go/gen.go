...
func (g *goEvalEmitter) writePrelude() {
	g.parser.writel(fmt.Sprintf("// Code generated by langlang (%s commit hash), DO NOT EDIT.", getCommitHash()))
	g.parser.writel(fmt.Sprintf("// Source File: %s", g.options.SourceFile))
