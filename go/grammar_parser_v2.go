...
//go:generate go run ./cmd/langlang -grammar ../grammars/langlang.peg -output-language goeval -output-path ./grammar_parser_bootstrap.go -go-remove-lib -go-package langlang -go-parser GrammarParserBootstrap
