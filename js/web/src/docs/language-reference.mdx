...
langlang supports characters outside the Basic Multilingual Plane
(BMP), including emoji. These require 4 bytes in UTF-8 and codepoints
above U+FFFF.
...
For example, `[🧠-🧬]` matches any emoji from U+1F9E0 (brain) to
